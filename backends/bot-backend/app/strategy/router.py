...
class StrategyRouter:
    ...
    def route_signal(
        ...
        for strat_name in strategies_to_run:
            ...
            # Confidence gating has been moved exclusively to SafetyEngine Layer A
            # to prevent Split-Brain threshold drift.
            # We no longer filter out signals based on dynamic thresholds here.
