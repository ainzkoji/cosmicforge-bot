...
class Settings(BaseSettings):
    ...
    # until a subsequent reviewed report clears the recommendation.
    STRONG_TREND_MONITOR_REPORT_PATH: str = "models/reports/strong_trend_paper_experiment_status.json"
