...
class PolicyContext:
    ...
    confidence_already_approved: bool = False
    ...
    def _determine_action(
        ...
        if pos == "LONG":
            ...
            if sig == "SELL":
                ...
                return Action.CLOSE, "close_long_on_sell", pending_open, reentry_sig, reentry_cnt
        ...
        if pos == "SHORT":
            ...
            if sig == "BUY":
                ...
                return Action.CLOSE, "close_short_on_buy", pending_open, reentry_sig, reentry_cnt
