...
- last_decision_time: 2026-07-17T23:29:43.209958+00:00
- last_order_time: 2026-06-17T12:30:44.589545+00:00
- last_fill_time: 2026-06-07T23:33:27.177152+00:00
- latest_block_reasons: `{'regime_blocked': 50, 'session_blocked': 50}`
- latest_hold_reasons: `{'regime_blocked': 50, 'session_blocked': 50}`
- latest_regime_distribution: `{'LOW_VOLATILITY_CHOP': 50, 'WEAK_TREND': 50}`
...
- order_consistency_note: Historical submit_attempted rows are failed attempts, not created paper orders.
...
|---|---|---|---|
| NO_TRADES_AFTER_24H | warning | Zero closed paper trades after 786.7 hours from clean start. | continue_monitoring |
| NO_TRADES_AFTER_72H | warning | Zero closed paper trades after 786.7 hours from clean start. | run_signal_audit |
| NO_TRADES_AFTER_7D | critical | Zero closed paper trades after 786.7 hours from clean start. | run_signal_audit |
| REGIME_BLOCKING_DOMINATES | info | Regime blocks are 50/100 latest traces. | review_strong_trend_experiment |
| STRONG_TREND_STOP_RECOMMENDED | critical | strong_trend_order_errors_since_experiment_start >= 2 | review_strong_trend_experiment |
