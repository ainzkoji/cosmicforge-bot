...
class TestBybitIntegration:
    ...
    def test_executor_normalization_integration(self):
        ...
        mock_client.get_klines.return_value = [
            [now_ms - 900_000, "50000", "50100", "49900", "50000", "1", now_ms - 1]
        ]
        ...
        mock_client.place_protection = MagicMock(return_value=ProtectionResult(
        ...
        # Initialize Executor
        executor = BinanceExecutor(client=mock_client, execution_mode="live")
