...
def test_be_fee_buffer_applied_long():
    ...
    # The lifecycle now keeps the larger of fee coverage and 20% of the
    # original stop distance, preventing a post-TP1 stop from being too tight.
    expected_buffer = max(40_000.0 * 0.0005 * 2.0 * 1.2, (40_000.0 - 38_000.0) * 0.20)
