    ...
    with db.connect() as conn:
        ...
        conn.execute(
            ...
            INSERT INTO trade_fills (
                ...
                strategy, strategy_version, broker_id, account_id, asset_class, market_type, execution_mode, timeframe, confidence,
