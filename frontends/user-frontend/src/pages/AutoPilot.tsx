    ...
    const handleDeploy = async () => {
        ...
        try {
            ...
            await api.deployAutoPilot({
                ...
                allocation: {
                    total_capital_budget: totalCapitalBudget,
                    trade_amount_per_position: allocationValue,
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <section className="bg-[#0B0E14] border border-white/5 rounded-2xl p-6 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label className="text-sm text-gray-400 mb-2 block">Total Capital Budget (USDT)</label>
                                <input
                                    type="number"
                                    min="1"
                                    value={totalCapitalBudget}
                                    onChange={(e) => setTotalCapitalBudget(Number(e.target.value))}
                            ...
                            <div className="flex-1">
                                <label className="text-sm text-gray-400 mb-2 block">
                                    {allocationType === "fixed_amount" ? "Trade Amount per Position (USDT)" : "Position Allocation (%)"}
                                </label>
