...
- `admin-frontend` is the sole intended owner of `/admin/*` routes and admin-only UI.
- New admin pages, admin hooks, admin components, and admin API wrappers should be added here, not in `user-frontend`.
- The ML Monitoring module will be migrated into this app in a later stage.
- This app is currently mixed with public/user pages as a legacy condition; those are later cleanup items, not part of the admin ownership rule.
